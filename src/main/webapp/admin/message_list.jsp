                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <%--<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addRowModal2" onclick="window.location.href='doAddMessage.do'">
                                            ...
                                            <tr>
                                                <td>${num.count}</td>
                                                    ...
                                                    <td><c:forEach items="${ulist}" var="k">
                                                        <c:if test="${k.id==u.fid}">
                                                            ${k.tname}
                                                        </c:if>
                                                    </c:forEach></td>
                                                    <td><c:forEach items="${ulist}" var="k">
                                                        <c:if test="${k.id==u.jid}">
                                                            ${k.tname}
                                                        </c:if>
                                                    </c:forEach></td>
                                                    <td>${u.note}</td>
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="编辑">
                                                            <a href="doUpdateMessage.do?id=${u.id}" ><i class="fa fa-edit"></i></a>
                                                        </button>
                                                        <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="删除">
                                                            <i class="fa fa-times"></i><a onclick="return del(1,1,1)" href="deleteMessage.do?id=${u.id}" >删除</a>
                                                        </button>
                                                        </c:if>
                                                    </div>
                                                </td>
