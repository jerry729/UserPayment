        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">货物表信息列表</h4>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <c:if test="${sessionScope.auser.utype=='管理员'}">
                                        <button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addRowModal" onclick="window.location.href='commodity_add.jsp'">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="small">创建货物表</p>
                                                <form method="post" action="addCommodity.do" >
                                                    <div class="row">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="编辑">
                                                            <a href="doUpdateCommodity.do?id=${u.comid}" ><i class="fa fa-edit"></i></a>
                                                        </button>
                                                        <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="删除">
                                                            <i class="fa fa-times"></i><a onclick="return del(1,1,1)" href="deleteCommodity.do?id=${u.comid}" >删除</a>
                                                        </button>
                                                        </c:if>
                                                    </div>
                                                </td>
