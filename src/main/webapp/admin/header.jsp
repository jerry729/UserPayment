            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm">
                            <c:if test="${sessionScope.auser.img==null}">
                                <img src="../upload/zanwu.jpg" alt="navbar brand" class="avatar-img rounded-circle" >
                            </c:if>
                            <c:if test="${sessionScope.auser.img!=null}">
                                <img src="../upload/${sessionScope.auser.img }" alt="navbar brand" class="avatar-img rounded-circle" >
                            </c:if>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg">
                                        <c:if test="${sessionScope.auser.img==null}">
                                            <img src="../upload/zanwu.jpg" alt="navbar brand" class="avatar-img rounded" >
                                        </c:if>
                                        <c:if test="${sessionScope.auser.img!=null}">
                                            <img src="../upload/${sessionScope.auser.img }" alt="navbar brand" class="avatar-img rounded" >
                                        </c:if>
                                       <%-- <img src="../upload/${sessionScope.auser.img }" alt="image profile" class="avatar-img rounded">--%>
                                    </div>
                                    <div class="u-text">
