        ...
        <div class="content">
            <div class="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form action="addUser_kh.do" method="post" enctype="multipart/form-data"><!--  -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <%--<div class="form-group">
                                                <label for="email2">客户名：</label>
                                                <input type="text" class="form-control" id="username" name="uname" placeholder="请输入客户名"  onblur="checkName()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="uname" placeholder="请输入用户名"  onblur="checkName()" required>
                                                    <small id="checku" class="form-text text-muted"></small>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="tname">姓名：</label>
                                                <input type="text" class="form-control" id="tname"  name="tname" placeholder="请输入客户姓名" required >
                                                <small id="checkName" class="form-text text-muted"></small>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtPwd">密码：</label>
                                                <input type="password" class="form-control" id="txtPwd" placeholder="请输入密码：" onblur="checkPwd();" required>
                                                <small id="checkPwd" class="form-text text-muted"></small>
                                            </div>
                                            <div class="form-group">
                                                <label >重复密码：</label>
                                                <input type="password" class="form-control" id="txtConfirmPwd" name="pwd" placeholder="请输入确认密码：" onblur="checkPwdc();" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="tel" name="tel" placeholder="请输入电话"  onblur="checkTel();" required>
