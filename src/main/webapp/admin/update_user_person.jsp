                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="tname" name="tname" value="${user.tname }" placeholder="请输入姓名：">
                                                <small id="checkPwd" class="form-text text-muted"></small>
                                            </div>

                                        <div class="form-group">
                                            <label >密码：</label>
                                            <input type="password" class="form-control" id="pwdc" name="pwd" value="${user.pwd}">
