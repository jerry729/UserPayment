                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <c:if test="${sessionScope.auser.utype=='业务员'}">
                                        <button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addRowModal" onclick="window.location.href='user_add_kh.jsp'">
