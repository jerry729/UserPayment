...
KindEditor.lang({
	...
	'image.remoteImage' : '网络博文',
	'image.localImage' : '本地上传',
	'image.remoteUrl' : '博文地址',
	'image.localUrl' : '上传文件',
	'image.size' : '博文大小',
	'image.width' : '宽',
	'image.height' : '高',
	...
	'image.imgTitle' : '博文说明',
	'image.upload' : '浏览...',
	'image.viewServer' : '博文空间',
	'multiimage.uploadDesc' : '允许用户同时上传<%=uploadLimit%>张博文，单张博文容量不超过<%=sizeLimit%>',
		...
		edit : function() {
			...
			self.plugin.imageDialog({
				...
				clickFn : function(url, title, width, height, border, align) {
					...
					// Bugfix: [Firefox] 上传博文后，总是出现正在加载的样式，需要延迟执行hideDialog
					setTimeout(function() {
						self.hideDialog().focus();
					}, 0);
				}
